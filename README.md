...
<table align="center" width="100%" style="border: none;">
  <tr>
    <td width="60%" valign="top">
      <h2>✦ About Me</h2>
      <p>I am a <strong>Computer Science Student</strong> and <strong>Full-Stack Developer</strong> with a profound focus on backend logic and scalable system architecture. I engineer robust solutions that bridge the gap between complex algorithms and seamless, engaging user interfaces.</p>
      <ul>
        <li>🔭 <strong>Currently Engineering:</strong> High-performance full-stack applications leveraging <b>Django</b> and <b>FastAPI</b>.</li>
        <li>🌱 <strong>Currently Mastering:</strong> Asynchronous programming, advanced state management, and API optimization.</li>
        <li>🤝 <strong>Open to Collaborate:</strong> End-to-end full-stack projects, database architectures, and open-source backend tools.</li>
        <li>⚡ <strong>Fun Fact:</strong> I treat semicolons in C like oxygen—forget one and everything stops. Yet, vertically centering a <code>&lt;div&gt;</code> still occasionally takes my breath away!</li>
      </ul>
    </td>
...
<p align="center"><i>A unified look at the tools and technologies I use to bring ideas to life.</i></p>
...
<div align="center">
  ...
  <table align="center" style="border: none;">
    <tr>
      ...
      <td align="center" width="96">
        <img src="https://skillicons.dev/icons?i=idea" width="48" /><br><b>IntelliJ</b>
      </td>
    </tr>
  </table>
</div>
